  ...
  return (
    <MainLayout>
      <div className="page-content">
        <PageGradientHeader emoji="✉️" title="Communication Center" subtitle="Send emails, SMS, and WhatsApp messages to parents" gradient="from-accent/10 via-blue-500/5 to-primary/5" />
